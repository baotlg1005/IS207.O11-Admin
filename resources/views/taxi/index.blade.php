        ...
        <div class="col-10 mb-3">
                <form action="{{ route('taxi.search') }}" method="GET">
                    <div class="row justify-content-end">
                        ...
                        <div class="col-2 d-flex align-items-center gap-2">
                            <div>PickPoint: </div>
                            <input type="text" name="PickPoint" class="form-control" placeholder="PickPoint" value="{{ request()->get('PickPoint') }}">
                        </div>
                        <div class="col-1">
        ...
        <tr>
            ...
            <td>
                <div class="d-flex justify-content-between align-items-center gap-2">
                    <a href="{{ route('taxi.edit', $taxi->ai_id) }}" class="btn btn-primary">Edit</a>
